...
VALUES ('Category 1', 'Category 1 description',  GETDATE() , GETDATE(), 'Admin', 'Admin', 0),
       ('Category 2', 'Category 2 description',  GETDATE() , GETDATE(), 'Admin', 'Admin', 0),
       ('Category 3', 'Category 3 description',  GETDATE() , GETDATE(), 'Admin', 'Admin', 0);

-- Thêm dữ liệu vào bảng "brand"
INSERT INTO Brand (Name, Description, CreateDate, UpdateDate, CreateBy, UpdateBy, Status)
VALUES ('Brand 1', 'Brand 1 description',  GETDATE() , GETDATE(), 'Admin', 'Admin', 0),
       ('Brand 2', 'Brand 2 description',  GETDATE() , GETDATE(), 'Admin', 'Admin', 0),
       ('Brand 3', 'Brand 3 description',  GETDATE() , GETDATE(), 'Admin', 'Admin', 0);

-- Thêm dữ liệu vào bảng "collar_style"
INSERT INTO Design (Name, Description, CreateDate, UpdateDate, CreateBy, UpdateBy, Status)
VALUES ('Design 1', 'Design 1 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Design 2', 'Design 2 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Design 3', 'Design 3 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0);

-- Thêm dữ liệu vào bảng "color"
INSERT INTO Color (Name, description, CreateDate, UpdateDate, CreateBy, UpdateBy, Status)
VALUES ('Color 1', 'Color 1 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Color 2', 'Color 2 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Color 3', 'Color 3 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0);

-- Thêm dữ liệu vào bảng "size"
INSERT INTO Size (Name, Description, CreateDate, UpdateDate, CreateBy, UpdateBy, Status)
VALUES ('Size 1', 'Size 1 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Size 2', 'Size 2 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Size 3', 'Size 3 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0);

-- Thêm dữ liệu vào bảng "material"
INSERT INTO material (Name, Description, CreateDate, UpdateDate, CreateBy, UpdateBy, Status)
VALUES ('Material 1', 'Material 1 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Material 2', 'Material 2 description', GETDATE() , GETDATE() , 'Admin', 'Admin', 0),
       ('Material 3', 'Material 3 description', GETDATE(), GETDATE(), 'Admin', 'Admin', 0);
...
VALUES ('image_url_1', 1, GETDATE() , GETDATE(), 'Admin', 'Admin', 0, 1),
       ('image_url_2', 0, GETDATE() , GETDATE() , 'Admin', 'Admin', 0, 2),
       ('image_url_3', 0, GETDATE() , GETDATE() , 'Admin', 'Admin', 0, 3);
...
VALUES ('John Doe', '123456789', '123 Main Street', 'City', 'District', 'Ward', 1, 1, 1, GETDATE() , GETDATE() , 'Admin', 'Admin', 0, 1),
       ('Jane Doe', '987654321', '456 Elm Street', 'City', 'District', 'Ward', 2, 2, 2, GETDATE() , GETDATE() , 'Admin', 'Admin', 0, 1);
...
VALUES ('HD01', GETDATE() , GETDATE(), GETDATE() , GETDATE() , 100.00, 10.00, 110.00, 'Note 1', 1, 1, 1, 3, 'GHN001', 1, 1, 1, 1, 1);
